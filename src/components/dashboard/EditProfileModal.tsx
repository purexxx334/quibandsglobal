...
export const EditProfileModal: React.FC<EditProfileModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-2.5 sm:p-4 bg-black/85 backdrop-blur-md overflow-y-auto overscroll-contain animate-fadeIn">
      <div className="relative w-full max-w-2xl bg-dark-950 border border-slate-800 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden my-auto sm:my-8 max-h-[92vh] flex flex-col">
