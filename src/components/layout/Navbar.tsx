...
export const Navbar: React.FC<NavbarProps> = ({ 
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              onClick={() => onOpenAuth('register')}
              className="gold-gradient-btn px-3 py-1.5 rounded-md text-xs"
            >
              Get Started
            </button>
            <button
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-x-0 top-full bg-dark-950/98 backdrop-blur-xl border-b border-white/10 shadow-2xl transition-all">
          <div className="px-6 py-6 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="text-xs text-gold-400 flex items-center gap-1 font-medium"
                >
            ...
            <div className="grid gap-2">
              {navLinks.map((link) => (
                <a
                  ...
                  className="flex items-center justify-between py-2 text-slate-200 hover:text-gold-400 font-medium text-sm transition-colors"
                >
                  {link.name}
            ...
            <div className="pt-4 border-t border-white/10 grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 py-2.5 rounded-lg border border-white/15 text-slate-200 text-sm font-medium hover:bg-white/5"
              >
                <LogIn className="w-4 h-4 text-gold-400" />
                Sign In
              </button>
              <button
                ...
                className="gold-gradient-btn flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm"
              >
                <UserPlus className="w-4 h-4" />
                Register
              </button>
