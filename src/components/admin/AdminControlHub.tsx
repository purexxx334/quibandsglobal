  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/85 backdrop-blur-md overflow-hidden">
      <div className="relative w-full max-w-7xl h-[94vh] bg-dark-950 border border-gold-500/30 rounded-2xl flex flex-col shadow-2xl overflow-hidden animate-fadeIn">
        ...
        {/* Top Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-dark-900">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-white font-mono tracking-tight">Institutional Admin Control Hub</h2>
                <span className="px-2 py-0.5 text-xs font-mono font-bold bg-gold-500 text-dark-950 rounded-full">
                  SUPERADMIN
                </span>
              </div>
              <p className="text-xs text-slate-400">Financial Balances, Miner Management, Gas Fee Approvals & System Settings</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={fetchData}
              disabled={loading}
              className="p-2 rounded-lg bg-dark-850 border border-white/10 text-slate-300 hover:text-white hover:border-gold-500/40 transition"
              title="Refresh Data"
            >
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-lg bg-dark-850 border border-white/10 text-slate-400 hover:text-white hover:bg-rose-500/20 hover:border-rose-500/40 transition"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
            <div className="w-full max-w-xl bg-dark-950 border border-gold-500/40 rounded-2xl p-6 shadow-2xl space-y-4 my-8">
              ...
              <form onSubmit={handleSaveFinancials} className="space-y-4 text-xs font-sans">
                ...
                {/* 1. Main Vault Balance */}
                <div className="p-3.5 bg-dark-900 rounded-xl border border-white/5 space-y-2">
                  <div className="flex justify-between items-center">
                    <label className="font-bold text-gold-400 uppercase tracking-wider text-[11px]">Main Vault Balance ($ USD)</label>
